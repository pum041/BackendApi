    ...
    public partial class MigratonName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A2B00D7BAB2", x => x.CategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CCAC20F02140", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6ED8F3753F4", x => x.ProductID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AdminAct__FFE3F4B941724670", x => x.ActionID);
                    table.ForeignKey(
                        name: "FK__AdminActi__Admin__5CD6CB2B",
                        column: x => x.AdminID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BAF0663F61E", x => x.OrderID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cart__51BCD7972C7B36B9", x => x.CartID);
                    table.ForeignKey(
                        name: "FK__Cart__ProductID__5535A963",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Licenses__72D600A276F7C5AB", x => x.LicenseID);
                    table.ForeignKey(
                        name: "FK__Licenses__Produc__4BAC3F29",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reviews__74BC79AE2051822D", x => x.ReviewID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__D3B9D30C5C39F40A", x => x.OrderDetailID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Payments__9B556A5857AC33A9", x => x.PaymentID);
                    table.ForeignKey(
                        name: "FK__Payments__OrderI__59063A47",
                        column: x => x.OrderID,
                        principalTable: "Orders",
                        principalColumn: "OrderID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Licenses__45E1DD6FBDC9CA91",
                table: "Licenses",
                column: "LicenseKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D105345C5F50E0",
                table: "Users",
                column: "Email",
                unique: true);
        }
